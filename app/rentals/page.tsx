...
export default async function RentalsPage() {
  ...
  return (
    <main className="relative flex-1 bg-[#faf9f6] pb-28 lg:pb-16">
      ...
      <div className="relative overflow-hidden border-b border-zinc-200/50 bg-gradient-to-br from-white via-blue-50/25 to-[#faf9f6]">
        <div className="home-hero-grid absolute inset-0 opacity-[0.035]" />
        <div className="pointer-events-none absolute -right-16 top-0 h-56 w-56 rounded-full bg-blue-200/30 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-8 sm:px-8 sm:py-10 lg:px-10">
          ...
          {activeCount > 0 && (
            <p className="mt-5 inline-flex items-center gap-2 rounded-full bg-blue-50 px-4 py-1.5 text-xs font-semibold text-blue-700 ring-1 ring-blue-100">
