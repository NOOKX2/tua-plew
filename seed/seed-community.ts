...
export const communityEvents: CommunityEvent[] = [
  {
    ...
    description:
      "รันนิ่งคลับที่ใหญ่ที่สุดในใจกลางกรุงเทพฯ วิ่งรอบสวนลุมพินี 5–10 กม. มี pacers แยกกลุ่มความเร็ว หลังวิ่งมี stretching และ networking กับเพื่อนนักวิ่ง มาเช่าชุดวิ่งที่จุด Tua Plew สวนลุมพินีได้เลยก่อนเริ่ม",
  ...
  },
  {
    ...
    description:
      "คลาสโยคะกลางแจ้งสไตล์ Hatha–Vinyasa เหมาะสำหรับผู้เริ่มต้นและผู้ที่ต้องการฟื้นฟูร่างกาย นำโดยครูโยคะที่มีประสบการณ์ นำชุดโยคะไปเองหรือเช่าชุดโยคะสะอาดจาก Tua Plew ใกล้สวนได้",
    activityType: "yoga",
    date: "2026-06-15",
    startTime: "06:30",
    endTime: "07:30",
